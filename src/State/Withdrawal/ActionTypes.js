...
export const WITHDRAWAL_PROCESSED_REQUEST = 'WITHDRAWAL_PROCESSED_REQUEST';
export const WITHDRAWAL_PROCESSED_SUCCESS = 'WITHDRAWAL_PROCESSED_SUCCESS';
export const WITHDRAWAL_PROCESSED_FAILURE = 'WITHDRAWAL_PROCESSED_FAILURE';
